...
try:
    if decisao_limiar == 0:
        Rx_bin_wave = Rx_filter.Digitalize(downsampled_wave, NPPS, N_Simb, threshold=0)
    elif decisao_limiar == 1:
        Rx_bin_wave = Rx_filter.Digitalize(downsampled_wave, NPPS, N_Simb, threshold='mean')
    elif decisao_limiar == 2:
        eye_treshold = Rx_filter.Eye_treshold(normalized_wave_noise)
        Rx_bin_wave = Rx_filter.Digitalize(downsampled_wave, NPPS, N_Simb, threshold=eye_treshold)
    else:
